...
OR EVENTS.event_code IN ('17Q001','17Q002')
...
SELECT
	...
	,'' AS 'CLM Count'
	,evdate AS 'Accident Date'
	,noticedt AS 'Reported Date'
	...
	,LB.incept AS 'Policy Effective Date'
	...
	,CASE DLY.ASL 
		...
		END AS "Category"  
	,'' AS 'Comments'
    ,COALESCE(TI.fyi,DLY.fyi,0) AS fyi
