SELECT 
    ...
    ,CASE WHEN NAD3.B27_NAME1 = 'Evanston Insurance Company' THEN 'Evanston Insurance Company (EIC)'
            ...
            WHEN NAD3.B27_NAME1 = 'Atlantic Specialty' THEN 'Atlantic Specialty Insurance Company (Atlantic Specialty)'
			ELSE NAD3.B27_NAME1
			END as "Legal Entity"
    ...
    LEFT JOIN RAW_ICON.ICON.NAME_ADDRESS NAC
	ON CR.E04_CLAIMANT_NUM = NAC.E04_ORIGNUM
	AND NAC.E04_NEXT IS NULL

 --   LEFT JOIN RAW_ICON.ICON.LD60_LOSS_TYPES T
